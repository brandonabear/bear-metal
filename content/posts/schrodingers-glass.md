...
A common thread in all of these use cases is that I retain understanding and control over the output of the LLM and validate what it produces. I refrain from outsourcing critical thinking or allowing my skills to atrophy anymore.

## Schrödinger's Glass

Is the glass half full or is it half empty? I'd argue it's a mistake to assume the state is inherently fixed. AI exists in a superposition: simultaneously an incredible technological achievement and a fast track to deskilling, burnout, and unvetted slop. What collapses that state is simply how you interact with it. If you hand over the reins, letting unsupervised agents generate thousands of lines of unvetted code, offloading your critical thinking, and accepting corporate hype at face value, you open the box to find an empty glass containing the carcass of your skills and critical thinking. But if you observe the technology through a lens of conscientious skepticism, forcing it to show its work, scoping it to narrow friction points, and keeping the cognitive burden on yourself, it can hold some genuine value.

I truly hope that the tech industry and society come to a more tempered understanding of what LLMs are and what they can do. Many of the challenges software developers are experiencing will likely be validated by studies over time, but for now, early detractors will continue to be labeled luddites until the pendulum of popular opinion swings back towards sanity. Given the growing anger around massive data center construction, that shift may arrive sooner than expected.

Corporations will likely continue to layoff staff, burn cash on tokens, accelerate capex, and gaslight their remaining employees into doing more work for less pay. Frontier labs will continue to make unfounded outrageous claims about a future that is perpetually six to twelve months away and investors will continue to throw their money at it. Software will continue its unwavering march towards enshittification. Users will unknowingly give themselves what amounts to mild brain damage using these products.

As for me? I think I'll just continue using my own brain, thank you very much.
