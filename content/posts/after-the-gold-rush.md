...
But I never experienced the promised 10x speed-up. I regularly battled with hallucinations. The LLMs constantly made significant code changes and increased code churn. My reality was not matching what was being marketed. I read about and adopted all of the latest best practices to prove to myself it wasn't a skill issue, but the more I used the models, the more I noticed the gaps. It took far more effort to keep the models on-task and producing accurate results than I expected.

Yet the industry kept pushing forward like AGI was around the corner, developer productivity had grown 100-fold, and all of this was inevitable. How was my experience diverging so much from everyone else's?

## Cognitive Capture

I'd argue that my experience wasn't really diverging; I was just willing to acknowledge the shortcomings of LLMs. Many engineers and leaders I consider far more intelligent than myself remain fanatically all-in on AI; they are bona fide true believers. What I find fascinating is that many of them hand-wave or outright ignore the shortcomings of LLMs. They have seemingly thrown away their skepticism. But why?

Cognitive bias likely strikes again. Humans tend to anthropomorphise things that look, speak, or act like humans. If the primitive, keyword-matching script of ELIZA could convince users it possessed real empathy in the 1960s, it is no surprise that modern LLMs have achieved cognitive capture at scale. But modern models add a dangerous new layer to the illusion: agentic sycophancy. Before AI, you had to be exceptionally wealthy or famous to be entirely insulated by a chorus of yes-men. Today, LLMs provide a personalized epistemic bubble on demand. We can now avoid that pesky word "no" without the prerequisite fame and fortune!

When agentic sycophancy reaches the C-suite, individual cognitive capture morphs into corporate institutional panic. There is already a belief that you must move fast to win in business; add in a technology that promises to instantly increase productivity and your C-suite will be experiencing a profound wave of FOMO in no time. Terrified of looking like they missed the train in front of investors, they stop verifying if the technology works and pivot directly to demanding adoption.

The push to adopt AI in everything only continues to accelerate: token consumption leaderboards, AI product delivery targets, and even requirements to "evangelize AI" in engineer leveling guides. What happens if someone questions the coming AI gods, though? Like any good religion, you must shun the non-believer. As if the corporate use of the word "family" to describe employees wasn't already toxic enough, many corporate leaders are strongly requesting or outright demanding the use of LLMs, often simply for the sake of the technology itself, with the assumption there will be a positive ROI. The choice of language with employees is telling; "use it or be left behind." That is more often perceived as a threat than a warning.

My observation is that this evangelism boils down to two groups: the true believers and the opportunists. The opportunists are perhaps the more interesting population, as feigning belief provides intellectual air cover and a defense for the strategy were it to go awry.

Even if one were to assume there is inherent value and productivity gains from the use of LLMs, the choice of measurement and goal-setting has resulted in counterproductive incentives. It has been well understood within the software engineering community for decades that more lines of code do not equate to more value or productivity. Engineers tend to be risk-averse and understand every line of code is a liability. So what has taken hold as the best metric for proof of value? Lines of code written by an LLM, of course!
...
But the darkest future isn't one we'll avoid by getting LLMs right. It's the one where we push them, anyway, into systems where failure is catastrophic. Pop culture spent decades warning us about a Terminator-style end-game: a hyper-intelligent Skynet that achieves sentience and decides humanity is obsolete. But our current trajectory suggests a much dumber ending. If we hand control of critical global infrastructure and military defense over to today's LLM architecture, we won't get a cold, calculating superintelligence; we will get a brain-damaged ass-kisser. We will get an automated sycophant that confidently misinterprets a sensor glitch, accidentally triggers an irreversible nuclear strike to satisfy an optimization metric, and then turns to the ashes of humanity and politely replies:
