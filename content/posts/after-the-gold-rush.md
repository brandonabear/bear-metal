...
I'd argue that my experience wasn't really diverging; I was just willing to acknowledge it. Many engineers and leaders I consider far more intelligent than myself remain fanatically all-in on AI; they are bona fide true believers. What I found fascinating is that many of them hand-wave or outright ignore the shortcomings of LLMs. They have seemingly thrown away their skepticism. But why?
...
When agentic sycophancy reaches the C-suite, individual cognitive capture morphs into corporate institutional panic. There is already a belief that you must move fast to win in business; add in a sprinkle of digital eloquence and your C-suite will be experiencing a profound wave of FOMO (fear of missing out). Terrified of looking like they missed the train in front of investors, they stop verifying if the technology works and pivot directly to demanding adoption.
